# Generated by Django 3.2.7 on 2021-10-01 22:55
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('0', 'employee'), ('1', 'teamlead'), ('2', 'boss')], default='1', max_length=20)),
                ...
                ('extraPhone', models.IntegerField()),
                ('spentaimes', models.TextField()),
                ('remote', models.BooleanField(default=False)),
                ('skype', models.CharField(max_length=36)),
