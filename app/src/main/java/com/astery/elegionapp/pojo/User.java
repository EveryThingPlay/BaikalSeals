...
public class User {
    ...
    @Ignore
    public User(int id, @NonNull String password, @NonNull String access, @NonNull String name, String lastName, @NonNull String surname, String email, String vacationName, String vacationRole, String manager, String passManager, String phone, String extraPhone, String spentaimes, String role, Boolean remote, String skype, String telegram, String birthday, String office, String division, String entity, String status, String employment, String workStart, String lastChanged, String lastChangedTime, String gender, Boolean blockLogin) {
        this.id = id;
