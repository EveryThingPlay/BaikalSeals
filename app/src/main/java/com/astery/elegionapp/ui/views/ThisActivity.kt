...
class ThisActivity : AppCompatActivity(), ParentActivity {
    ...
    override fun move(action: FragmentNavController, bundle: Bundle?) {
        ...
        when(action){
            FragmentNavController.LOGIN-> binding.bottomNavigation.visibility = GONE
            FragmentNavController.AUTH-> binding.bottomNavigation.visibility = GONE
    ...
    override fun onCreateOptionsMenu(menu: Menu?): Boolean {
        ...
        menu!!.findItem(R.id.profile).setOnMenuItemClickListener {
            move(FragmentNavController.PROFILE, null)
