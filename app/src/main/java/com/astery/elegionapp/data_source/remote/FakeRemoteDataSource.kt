    ...
    override fun <T> getData(listener: GetItemListener<List<T>>, className: Class<T>) {
        when (className.simpleName) {
            ...
            "User" -> {
                ...
                list.add(User(1, "asdsad", "adasd", "Алексей", "Петрович", "Гойко", "adsfdf@gmail.com",
                "JR Android developer", "Разработчик программного обеспечения", "asdasd", "asd", "+79003260055",
                "+79884569944", "asd", "JR Android developer", false, "@skype", "@username", "20.05.1920", "Санкт Петербург",
                "СПБ, HR", "nasda", "sss", "asd", "17.08.2020", "Ф", "10.10.2020",
                "0", false))
